...
}: { width: number, height: number, debounceUpdateTimer: (time: number, percent: number | undefined) => void, directUpdateTimer: (time: number, percent: number | undefined) => void, duration: number, isPlaying: boolean, xScale: ScaleLinear<number, number>, startTime: number, initialTime: number, speed: number }) {
